...
function enterLvl2() {
    ...
    //Block information
    var BlockSet = [
        { antallBlokker: 80, xPos: 0, yPos:550, damage: 0, jump: 0, speed: 0, name: "vanlig" },
        ...
        { antallBlokker: 0, xPos: 0, yPos: 520, damage: 0, jump: 5, speed: 0, name: "jump" },
...
class blocks {
    ...
    */
    ...
    var EnemySet = [
        ...
        { antallEnemies: 15, xPos: 60, yPos: 200, yspd: 0.5, xspd: 1.5, width: 40, height: 59, gravity: 5, weight: 0.1, currentHp: 5, damage: 0, range: 10, name: "feX" },
        { antallEnemies: 25, xPos: 30, yPos: 100, yspd: 1.5, xspd: 0.5, width: 40, height: 59, gravity: 5, weight: 0.1, currentHp: 5, damage: 0, range: 100, name: "feY" },
    ...
    for (var i = 0; i < EnemySet.length; i++) {
        ...
        for (var j = 0; j < EnemySet[i].antallEnemies; j++) {
            ...
            if (EnemySet[i].name === "normal") {
                ...
                enemies[i][j] = new entity("img/Feen 3.png", EnemySet[i].xPos + (j * 100), EnemySet[i].yPos, EnemySet[i].width, EnemySet[i].height, EnemySet[i].yspd, EnemySet[i].gravity, EnemySet[i].weight, EnemySet[i].currentHp, EnemySet[i].damage);
            }
